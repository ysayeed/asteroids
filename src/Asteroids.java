...
/**
 *
 * @author Yasien Sayeed
 */
// To Run project, open with Eclipse/Netbeans and use Shift+F6
...
public class Asteroids extends Applet implements KeyListener, ActionListener {
    ...
    public boolean Collision(VectorSprite v1, VectorSprite v2) {
        // checks collisions between Sprites
        int x, y;
    ...
    public void checkCollision() {
        // checks all Sprites to see if there's any collision
        for (int i = 0; i < RockList.size(); i++) {
...
//        }
    ...
    public boolean isRespawnSafe() {
        // waits until spawn area is clear before respawning ship
    ...
    public void removeOldPowerups() {
        // removes powerups after a while
        for (int i = 0; i < PowerupList.size(); i++) {
    ...
    public void AsteroidHoming() {
        // drags asteroids towards ship slighly
    ...
    public void BlackholeEffect() {
        // pulls ship towards black hole and removes wraparound
        double a, b, newA, xshift, yshift;
